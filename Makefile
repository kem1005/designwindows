...
# Template: app
# Command: /usr/bin/qmake6 -o Makefile designwindow.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = designwindow1.0.0
DISTDIR = /home/runner/work/designwindows/designwindows/.tmp/designwindow1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		designwindow.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = designwindow
DESTDIR       = 
TARGET        = designwindow
...
designwindow: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: designwindow.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile designwindow.pro
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/runner/work/designwindows/designwindows/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/runner/work/designwindows/designwindows -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/designwindow/bin || mkdir -p $(INSTALL_ROOT)/opt/designwindow/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/designwindow/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/designwindow/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/designwindow/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/designwindow/bin/ 
